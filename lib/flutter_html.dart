...
class Html extends StatelessWidget {
  Html({
    ...
    @required this.data,
    this.padding,
    this.textPadding = const EdgeInsets.only(left: 15, right: 15),
    this.imagePadding = const EdgeInsets.only(bottom: 20),
  ...
  Widget build(BuildContext context) {
    final double width = shrinkToFit ? null : MediaQuery
        .of(context)
        .size
        .width;
